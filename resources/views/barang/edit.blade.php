        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="/{{auth()->user()->level}}/barang/{{$barang->id}}" method="POST">
                    ...
                    <a href="/{{auth()->user()->level}}/barang" class="btn btn-sm btn-outline-danger"><i class="fas fa-caret-left"></i>
                        Kembali</a>
                    <button type="submit" class="btn btn-sm btn-outline-success"><i class="fas fa-edit"></i>
                        Edit</button>
                </form>
            </div>
        </div>
